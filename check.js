document.addEventListener('DOMContentLoaded', function () {
    document.querySelector('button').addEventListener('click', checkFollow);
});

var link = document.createElement('link');
link.rel = 'stylesheet';
link.type = 'text/css';
link.href = chrome.runtime.getURL('checkerStyle.css');
...
function checkFollow() {
    ...
    (async () => {
        try {
            ...
            window.localStorage.setItem('data', JSON.stringify(data, null, 4));
